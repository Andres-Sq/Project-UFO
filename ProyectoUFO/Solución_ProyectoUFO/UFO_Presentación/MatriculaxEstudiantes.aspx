<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MatriculaxEstudiantes.aspx.cs" Inherits="UFO_Presentación.WebForm4" %>
        ...
        <div>
            ...
            <section class="caja-botones contenedor">
                <div class="contenedor">
                    <asp:LinkButton ID="btnAgregar" CssClass="boton-contactar" runat="server"><i class="fa-solid fa-list"></i></asp:LinkButton>
                </div>
                <!-- GRIDVIEW-->
                <div>
