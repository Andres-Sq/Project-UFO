        ...
        <div>
            ...
            <section class="caja-botones contenedor">
                <div class="contenedor">
                    ...
                    <asp:LinkButton ID="btnModificar" CssClass="boton-contactar" runat="server"><i class="fa-solid fa-gear"></i></asp:LinkButton>
                      <asp:TextBox ID="txtEstado" onkeypress="" onpaste="return false;" onCopy="return false" onCut="return false" onDrag="return false" onDrop="return false" runat="server" placeholder="Estado"></asp:TextBox>
                </div>
                <!-- GRIDVIEW-->
                <div>
                    <asp:GridView runat="server" CssClass="table table-light table-sm"></asp:GridView>
                </div>
            </section>
        </div>
    </form>
